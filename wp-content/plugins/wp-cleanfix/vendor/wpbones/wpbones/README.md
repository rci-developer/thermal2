...
You can use [WP CleanFix](https://github.com/wpbones/WPCleanFix) repo as a boilerplate to create a plugin.
...
You may start from [WP CleanFix](https://github.com/wpbones/WPCleanFix) repo as a boilerplate to create a WP Bones WordPress plugin.
