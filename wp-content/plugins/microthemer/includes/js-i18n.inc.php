...
$TvrLang = array(
	...
	*/
	...
	'suggested' => esc_html__('Suggested styles', 'microthemer'),

	'suggestions' => esc_html__('Suggestions', 'microthemer'),

	'recent' => esc_html__('Suggestions', 'microthemer'), // always call recent suggestions as it may often include MT sug
	//'clear_recent' => esc_html__('Clear recent styles', 'microthemer'),

	'sampled' => esc_html__('Site styles', 'microthemer'),

	'clear_sampled' => esc_html__("Clear %s site styles from menu", 'microthemer'),
