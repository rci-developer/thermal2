...
//$prop_label = ($prop_label == 'display-flex') ? 'display': $prop_label;
 ...
 class="property-tag field-wrap tvr-clearfix subgroup-'.$this->subgroup.' '.$man_class . ' '.$field_class
	...
	// render normal property input
		...
		if ($property === 'event_value'){
			...
			<input class="color mt-supplementary-picker" name="mt_sup_picker" value="'.$picker_value.'" />
			</span>';
		}
