...
$this->edge_mode = array(
	'available' => true,
	'edge_forum_url' => 'https://themeover.com/forum/topic/new-recent-suggested-and-sampled-styles-feature-feedback-wanted/',
	'cta' => __("Try out the new recent, suggested, and sampled styles for properties like font-family, width, margin, border, and box-shadow.", 'microthemer'),
	'config' => array(
		// 'slideless_wizard' => 1
	),
...
// animation/ transition event triggers
...
$this->event_triggers = $this->to_autocomplete_arr($event_triggers);
