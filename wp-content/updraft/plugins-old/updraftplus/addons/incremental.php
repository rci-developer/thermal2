...
class UpdraftPlus_Addons_Incremental {
	...
	public function __construct() {
		...
		add_filter('updraftplus_initial_jobdata', array($this, 'incremental_jobdata'), 10, 2);
	 ...
	 */
	public function incremental_jobdata($jobdata, $options) {
		global $updraftplus;
		
		if (!is_array($jobdata)) return $jobdata;
		
		if (empty($options['incremental'])) return $jobdata;
