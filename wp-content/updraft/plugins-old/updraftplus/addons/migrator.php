...
class UpdraftPlus_Addons_Migrator {
	...
	public function updraftplus_migrate_tab_output() {
		...
		echo '<div id="updraft_migrate_tab_main">';
...
// echo __('To restore using any of the backup sets below, press the button.', 'updraftplus').' '.
		...
		echo '<div id="updraft_migrate_tab_alt" style="display:none;"></div>';
	...
	class UpdraftPlus_Addons_Migrator_RemoteSend extends UpdraftPlus_RemoteSend {
		...
		public function updraft_migrate_after_widget() {
			...
			<div class="updraft_migrate_widget_module">
				...
				<div class="updraft_migrate_widget_module_content">
					<p class="updraftplus_clone_status"></p>
		...
		public function admin_footer() {
			...
			<script>
				...
				function updraft_migrate_go_backup() {
					...
					jQuery('#updraft-navtab-status').trigger('click');
				}
				...
				function updraft_migrate_widget_reset() {
					...
					$('.updraft_migrate_widget_module [class^=updraft_migrate_widget_temporary_clone_stage]').hide();
